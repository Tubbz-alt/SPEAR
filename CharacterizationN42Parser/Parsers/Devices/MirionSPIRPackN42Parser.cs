...
{
    public class MirionSpirPackN42Parser : FileParser
    {
        /////////////////////////////////////////////////////////////////////////////////////////
        // Properties
        /////////////////////////////////////////////////////////////////////////////////////////
        ...
        public override string FileName { get { return "MirionSpirPack_N42"; } }


        /////////////////////////////////////////////////////////////////////////////////////////
        // Constructor
        /////////////////////////////////////////////////////////////////////////////////////////
        public MirionSpirPackN42Parser()
        {
        ...
        private void ParseFiles()
        {
            ...
            foreach (string filePath in filePaths)
            {
                ...
                deviceData = new DeviceData(DeviceInfo.Type.MirionSpirPack);
        ...
        private bool ParseN42File()
        {
            ...
            try
            {
                ...
                if (radMeasurementFound == true)
                {
                    ...
                    // CountRate
                    deviceData.CountRate = analysisResultsType.GrossCountAnalysisResults.AverageCountRateValue.Value;
                }
