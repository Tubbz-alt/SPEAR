...
{
    public class FlirR400SpeParser : FileParser
    {
        /////////////////////////////////////////////////////////////////////////////////////////
        // Properties
        /////////////////////////////////////////////////////////////////////////////////////////
        ...
        public override string FileName { get { return "FlirR400_SPE"; } }


        /////////////////////////////////////////////////////////////////////////////////////////
        // Constructor
        /////////////////////////////////////////////////////////////////////////////////////////
        public FlirR400SpeParser()
        {
        ...
        {
            SortedList<DateTime, DeviceData> identiFinder2s = new SortedList<DateTime, DeviceData>();
            ...
            foreach (string filePath in speFilePaths)
            {
                ...
                // Add to other parsed
                identiFinder2s.Add(deviceData.StartDateTime, deviceData);
            }

            // Number all the events
            int trailNumber = 1;
            foreach (KeyValuePair<DateTime, DeviceData> tempDevice in identiFinder2s)
            {
            ...
            deviceDatasParsed = identiFinder2s.Values.ToList();
        }
        ...
        private bool ParseSpeFile()
        {
            ...
            try
            {
                ...
                // Get CountRate
                value = speDictionary["FLIR_DOSE_RATE_SWMM"].Trim().Split('\n').FirstOrDefault();
