...
namespace SPEAR.Models.N42.v2011
{
    ...
    public partial class RadMeasurementType : ReqIdComplexObjectType
    {
        ...
        /// <remarks/>
        [XmlIgnore]
        public DateTime StartDateTime_DateTime
        {
            get
            {
                DateTime result;
                if (DateTime.TryParse(this.startDateTimeField, out result))
                    return result;
                //2019-12-10T10:24:55-0800
                if (DateTime.TryParseExact(this.startDateTimeField, "yyyy-MM-ddThh:mm:ss-zzzz", CultureInfo.InvariantCulture, DateTimeStyles.None, out result))
                    return result;
                return new DateTime();
            }
        }

        [XmlElementAttribute("StartDateTime")]
