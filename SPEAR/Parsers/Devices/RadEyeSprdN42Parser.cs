...
{
    public class RadEyeSprdN42Parser : FileParser
    {
        /////////////////////////////////////////////////////////////////////////////////////////
        // Properties
        /////////////////////////////////////////////////////////////////////////////////////////
        ...
        public override string FileName { get { return "RadEyeSPRD_N42"; } }


        /////////////////////////////////////////////////////////////////////////////////////////
        // Constructor
        /////////////////////////////////////////////////////////////////////////////////////////
        public RadEyeSprdN42Parser()
        {
        ...
        private bool ParseN42File()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < itemsElementNames.Count(); i += 1)
                {
                    ...
                    if (radMeasurementFound == false)
                    {
                        if (itemsElementNames[i] == ItemsChoiceType2.RadMeasurement)
                        {
                            ...
                            if (radMeasurementType.id.StartsWith("FG-") && radMeasurementType.MeasurementClassCode == MeasurementClassCodeSimpleType.Foreground)
                ...
                int sum = radMeasurementType.Spectrum.FirstOrDefault().ChannelData.Text
                    .Split(Globals.Delims_NewLine_Space, StringSplitOptions.RemoveEmptyEntries)
                    .Sum(c => int.Parse(c));
                ...
                for (int i = 0; i < nuclides.Count(); i += 1)
                {
                    ...
                    for (int c = 0; c < elementNames.Length; c += 1)
                    {
                        ...
                        {
                            deviceData.Nuclides[nuclideIndex++] = new NuclideID(nuclides[i].NuclideName, (double)nuclides[i].Items[c]);
                            break;
                        }
                    }
                }
