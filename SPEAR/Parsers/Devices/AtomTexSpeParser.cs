...
{
    public class AtomTexSpeParser : FileParser
    {
        /////////////////////////////////////////////////////////////////////////////////////////
        // Properties
        /////////////////////////////////////////////////////////////////////////////////////////
        ...
        public override string FileName { get { return "AtomTex_SPE"; } }


        /////////////////////////////////////////////////////////////////////////////////////////
        // Constructor
        /////////////////////////////////////////////////////////////////////////////////////////
        public AtomTexSpeParser()
        {
        ...
        private bool ParseSpeFile()
        {
            ...
            try
            {
                ...
                {
                    string[] splitSplitResult = splitResult[i].Split(Globals.Delim_Space, StringSplitOptions.RemoveEmptyEntries);
                    if (splitSplitResult.Length != 2)
                        continue;
                    string nuclide = splitSplitResult[0].Replace("I-", string.Empty);
                    double confidence = double.Parse(splitSplitResult[1].Substring(1, splitSplitResult[1].Length - 2));
